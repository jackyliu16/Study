    ...
    static Double[][] analyse(String[][] a, String[] split) {
        ...
        */
        ...
        for( int i = 1; i < a.length ; i++){
            ...
            // if it wasn't null -> using bubble sort to find biggest and smallest one in a year
            if (sp != 0) {
                if (recode[sp][2] == null)
            ...
            if (aInSection(a[i][0],split,sp)){
                // if a in range(sp,sp+1]year. -> using bubble sort to find biggest and smallest one.
...
*/
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("please makesure this file is been put at a folder which is name src, with a subfolder name data , which incluing the data you want");
